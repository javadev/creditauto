...
public class TemplatePage extends WebPage {
    ...
    public TemplatePage() {
        ...
        add(new BookmarkablePageLink("goodSelectionPageMenu", org.bitbucket.creditauto.wicket.workflow.GoodSelectionPage.class));
        add(new BookmarkablePageLink("goodSelectionPage", org.bitbucket.creditauto.wicket.workflow.GoodSelectionPage.class));
        add(new BookmarkablePageLink("requestsListPageMenu", org.bitbucket.creditauto.wicket.workflow.RequestsListPage.class));
        add(new BookmarkablePageLink("requestsListPage", org.bitbucket.creditauto.wicket.workflow.RequestsListPage.class));
        add(new BookmarkablePageLink("usersListPage", org.bitbucket.creditauto.wicket.workflow.UsersListPage.class));
        add(new BookmarkablePageLink("addNewUserPage", org.bitbucket.creditauto.wicket.workflow.AddNewUserPage.class));
        add(new BookmarkablePageLink("passwordPage", PasswordPage.class));
        add(new BookmarkablePageLink("complainPage", org.bitbucket.creditauto.wicket.workflow.ComplainPage.class));
        add(new Label("title", "Personal finance::Главная страница"));
        String calledMe = whoCalledMe();
        if (!calledMe.contains("PasswordPage") && !calledMe.contains("LogoutPage")
            && !new AuthorizationServerImpl().isPasswordValid(getCreditautoSession().getUser())) {
    ...
    protected void saveWorkflowPath(String uiName) {
        ...
        if (inInstance.getIn_dossier().getUi_workflow_path() == null) {
            ...
            inInstance.getIn_dossier().setUi_workflow_path(
