...
public class AddNewUserPage extends TemplatePage {
    ...
    public AddNewUserPage(In_instance inInstance) {
    ...
    public static String getTitle() {
        return "Добаление нового пользователя системы";
    }
    ...
    protected class MainForm extends Form {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                ddc1.add(new org.bitbucket.creditauto.wicket.UserLoginValidator(user.getId()));
