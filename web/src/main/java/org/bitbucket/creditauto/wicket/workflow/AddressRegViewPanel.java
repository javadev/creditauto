...
public class AddressRegViewPanel extends Panel {
    protected IDictionary dictionary;
    private final   In_person modelObject;
    
    
        public AddressRegViewPanel(String id, IModel model) {
            super(id, model);
    ...
    CompoundPropertyModel model = new CompoundPropertyModel(modelObject); 
            ...
            form.setOutputMarkupId(true);
                ...
                DictionaryTextField ddc1 = new DictionaryTextField("dictionary_regprovince_id",
                ...
                DictionaryTextField ddc2 = new DictionaryTextField("dictionary_regregion_id",
                ...
                DictionaryTextField ddc3 = new DictionaryTextField("dictionary_regcity_id",
