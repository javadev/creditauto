...
public class CarDetailsInfoViewPage extends GoodSelectionViewPage {
    
    
    public CarDetailsInfoViewPage() {
        super();
    ...
    public CarDetailsInfoViewPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends GoodSelectionViewPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends GoodSelectionViewPage.MainPanel.MainForm {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                form.addOrReplace(new Link("back") {
                    @Override 
                    public void onClick()  {
            setResponsePage(new GoodSelectionViewPage(inInstance));
                    }           
                                    });
