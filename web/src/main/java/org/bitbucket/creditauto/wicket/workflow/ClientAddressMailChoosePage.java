...
public class ClientAddressMailChoosePage extends ClientAddressRegChoosePage {
    
    
    public ClientAddressMailChoosePage() {
        super();
    ...
    public ClientAddressMailChoosePage(In_instance inInstance) {
        super(inInstance);
    ...
    private void init() {
        ...
        ajaxTabbedPanel.setSelectedTab(5 - 1);
    ...
    protected class MainPanel extends ClientAddressRegChoosePage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends ClientAddressRegChoosePage.MainPanel.MainForm {
...
form.add(new AddressMailPanel("clientAddressMail", new PropertyModel(inInstance, "in_person")));
