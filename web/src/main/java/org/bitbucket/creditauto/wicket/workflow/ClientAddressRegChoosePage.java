...
public class ClientAddressRegChoosePage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public ClientAddressRegChoosePage() {
        super();
    ...
    public ClientAddressRegChoosePage(In_instance inInstance) {
...
form.add(new AddressRegPanel("clientAddressReg", new PropertyModel(inInstance, "in_person")));
