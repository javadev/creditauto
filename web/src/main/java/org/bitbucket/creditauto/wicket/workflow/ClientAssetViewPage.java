...
public class ClientAssetViewPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public ClientAssetViewPage() {
        super();
    ...
    public ClientAssetViewPage(In_instance inInstance) {
    ...
    protected class MainForm extends Form {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                DictionaryTextField ddc1 = new DictionaryTextField("in_assets.0.dictionary_asset_id",
                ...
                form.get("in_assets.0.dictionary_asset_line").setVisible(inInstance.getIn_assets().size() > 0 && inInstance.getIn_assets().get(0).getCount_of() != null);
                ...
                form.get("in_assets.0.count_of_line").setVisible(inInstance.getIn_assets().size() > 0 && inInstance.getIn_assets().get(0).getCount_of() != null);

                DropDownChoice ddc3 = new DropDownChoice("in_assets.1.dictionary_asset_id",
                    dictionary.getDictionary("assetList", IDictionary.LANGUAGE_RU, new Date()),
                        new ChoiceRenderer("dvalue"));
                ddc3.setModel(new DictionaryModelWrapper(model.bind("in_assets.1.dictionary_asset"), ddc3));
                ddc3.setNullValid(true);
                form.add(new LineBorder("in_assets.1.dictionary_asset_line", new EditBorder("in_assets.1.dictionary_asset_border", ddc3, true)));
                ...
                form.get("in_assets.1.dictionary_asset_line").setVisible(inInstance.getIn_assets().size() > 1 && inInstance.getIn_assets().get(1).getCount_of() != null);

                TextField ddc4 = new TextField("in_assets.1.count_of_id", model.bind("in_assets.1.count_of"));
                form.add(new LineBorder("in_assets.1.count_of_line", new EditBorder("in_assets.1.count_of_border", ddc4, true)));
                ddc4.setOutputMarkupId(true);
                ddc4.setEnabled(false);
                form.get("in_assets.1.count_of_line").setOutputMarkupPlaceholderTag(true);
                form.get("in_assets.1.count_of_line").setVisible(inInstance.getIn_assets().size() > 1 && inInstance.getIn_assets().get(1).getCount_of() != null);

                DictionaryTextField ddc5 = new DictionaryTextField("in_assets.2.dictionary_asset_id",
                    dictionary.getDictionary("assetList", IDictionary.LANGUAGE_RU, new Date()),
                        new ChoiceRenderer("dvalue"));
                ddc5.setModel(new DictionaryModelWrapper(model.bind("in_assets.2.dictionary_asset"), ddc5));
                form.add(new LineBorder("in_assets.2.dictionary_asset_line", new EditBorder("in_assets.2.dictionary_asset_border", ddc5, true)));
                ...
                form.get("in_assets.2.dictionary_asset_line").setVisible(inInstance.getIn_assets().size() > 2 && inInstance.getIn_assets().get(2).getCount_of() != null);

                TextField ddc6 = new TextField("in_assets.2.count_of_id", model.bind("in_assets.2.count_of"));
                form.add(new LineBorder("in_assets.2.count_of_line", new EditBorder("in_assets.2.count_of_border", ddc6, true)));
                ddc6.setOutputMarkupId(true);
                ddc6.setEnabled(false);
                form.get("in_assets.2.count_of_line").setOutputMarkupPlaceholderTag(true);
                form.get("in_assets.2.count_of_line").setVisible(inInstance.getIn_assets().size() > 2 && inInstance.getIn_assets().get(2).getCount_of() != null);

                DictionaryTextField ddc7 = new DictionaryTextField("in_assets.3.dictionary_asset_id",
                    dictionary.getDictionary("assetList", IDictionary.LANGUAGE_RU, new Date()),
                        new ChoiceRenderer("dvalue"));
                ddc7.setModel(new DictionaryModelWrapper(model.bind("in_assets.3.dictionary_asset"), ddc7));
                form.add(new LineBorder("in_assets.3.dictionary_asset_line", new EditBorder("in_assets.3.dictionary_asset_border", ddc7, true)));
                ...
                form.get("in_assets.3.dictionary_asset_line").setVisible(inInstance.getIn_assets().size() > 3 && inInstance.getIn_assets().get(3).getCount_of() != null);

                TextField ddc8 = new TextField("in_assets.3.count_of_id", model.bind("in_assets.3.count_of"));
                form.add(new LineBorder("in_assets.3.count_of_line", new EditBorder("in_assets.3.count_of_border", ddc8, true)));
                ddc8.setOutputMarkupId(true);
                ddc8.setEnabled(false);
                form.get("in_assets.3.count_of_line").setOutputMarkupPlaceholderTag(true);
                form.get("in_assets.3.count_of_line").setVisible(inInstance.getIn_assets().size() > 3 && inInstance.getIn_assets().get(3).getCount_of() != null);
