...
public class ClientDocumentStoreViewPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public ClientDocumentStoreViewPage() {
        super();
    ...
    public ClientDocumentStoreViewPage(In_instance inInstance) {
    ...
    protected class MainForm extends Form {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                AjaxCheckBox ddc2 = new AjaxCheckBox("in_document_stores.0.is_not_required_id", model.bind("in_document_stores.0.is_not_required")) {
                                            @Override
                        protected void onUpdate(AjaxRequestTarget target) {
                             
                        }                    
                                                        };
                form.add(new LineBorder("in_document_stores.0.is_not_required_line", new EditBorder("in_document_stores.0.is_not_required_border", ddc2, true)));
                ddc2.setOutputMarkupId(true);
                ddc2.setEnabled(false);

                FileUploadField ddc3 = new FileUploadField("in_document_stores.1.data_id");
                ddc3.setModel(new FileUploadModelWrapper(model.bind("in_document_stores.1")));
                form.add(new LineBorder("in_document_stores.1.data_line", new EditBorder("in_document_stores.1.data_border", ddc3, false)));
                ddc3.setOutputMarkupId(true);
                ddc3.setEnabled(false);

                AjaxCheckBox ddc4 = new AjaxCheckBox("in_document_stores.1.is_not_required_id", model.bind("in_document_stores.1.is_not_required")) {
                                            @Override
                        protected void onUpdate(AjaxRequestTarget target) {
                             
                        }                    
                                                        };
                form.add(new LineBorder("in_document_stores.1.is_not_required_line", new EditBorder("in_document_stores.1.is_not_required_border", ddc4, true)));
                ddc4.setOutputMarkupId(true);
                ddc4.setEnabled(false);

                FileUploadField ddc5 = new FileUploadField("in_document_stores.2.data_id");
                ddc5.setModel(new FileUploadModelWrapper(model.bind("in_document_stores.2")));
                form.add(new LineBorder("in_document_stores.2.data_line", new EditBorder("in_document_stores.2.data_border", ddc5, false)));
                ddc5.setOutputMarkupId(true);
                ddc5.setEnabled(false);

                AjaxCheckBox ddc6 = new AjaxCheckBox("in_document_stores.2.is_not_required_id", model.bind("in_document_stores.2.is_not_required")) {
                                            @Override
                        protected void onUpdate(AjaxRequestTarget target) {
                             
                        }                    
                                                        };
                form.add(new LineBorder("in_document_stores.2.is_not_required_line", new EditBorder("in_document_stores.2.is_not_required_border", ddc6, true)));
