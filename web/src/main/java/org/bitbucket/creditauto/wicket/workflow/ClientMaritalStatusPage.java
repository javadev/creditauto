...
public class ClientMaritalStatusPage extends ClientPersonalInfoPage {
    
    
    public ClientMaritalStatusPage() {
        super();
    ...
    public ClientMaritalStatusPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends ClientPersonalInfoPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends ClientPersonalInfoPage.MainPanel.MainForm {
...
form.add(new MaritalStatusPanel("clientMarital", new PropertyModel(inInstance, "in_person")));

                form.addOrReplace(new Link("back") {
                    @Override 
                    public void onClick()  {
            setResponsePage(new ClientPersonalInfoPage());
                    }           
                                    });
