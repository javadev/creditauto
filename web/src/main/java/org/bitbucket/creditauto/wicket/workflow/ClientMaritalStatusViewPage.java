...
public class ClientMaritalStatusViewPage extends ClientPersonalInfoViewPage {
    
    
    public ClientMaritalStatusViewPage() {
        super();
    ...
    public ClientMaritalStatusViewPage(In_instance inInstance) {
        super(inInstance);
    ...
    private void init() {
        ...
        ajaxTabbedPanel.setSelectedTab(3 - 1);
    ...
    protected class MainPanel extends ClientPersonalInfoViewPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends ClientPersonalInfoViewPage.MainPanel.MainForm {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                DictionaryTextField ddc1 = new DictionaryTextField("in_person.dictionary_marital_status_id",
                    dictionary.getDictionary("maritalStatus", IDictionary.LANGUAGE_RU, new Date()),
                        new ChoiceRenderer("dvalue"));
                ddc1.setModel(new DictionaryModelWrapper(model.bind("in_person.dictionary_marital_status"), ddc1));
                form.add(new LineBorder("in_person.dictionary_marital_status_line", new EditBorder("in_person.dictionary_marital_status_border", ddc1, true)));
                ddc1.setOutputMarkupId(true);
                ddc1.setEnabled(false);

                TextField ddc2 = new TextField("in_person.number_of_children_id", model.bind("in_person.number_of_children"));
                form.add(new LineBorder("in_person.number_of_children_line", new EditBorder("in_person.number_of_children_border", ddc2, true)));
                ddc2.setOutputMarkupId(true);
                ddc2.setEnabled(false);

                DictionaryTextField ddc3 = new DictionaryTextField("in_person.dictionary_habitation_situation_id",
                    dictionary.getDictionary("habitationSituation", IDictionary.LANGUAGE_RU, new Date()),
                        new ChoiceRenderer("dvalue"));
                ddc3.setModel(new DictionaryModelWrapper(model.bind("in_person.dictionary_habitation_situation"), ddc3));
                form.add(new LineBorder("in_person.dictionary_habitation_situation_line", new EditBorder("in_person.dictionary_habitation_situation_border", ddc3, true)));
                ddc3.setOutputMarkupId(true);
                ddc3.setEnabled(false);

                TextField ddc4 = new TextField("in_person.habit_situation_start_date_id", model.bind("in_person.habit_situation_start_date"));
                form.add(new LineBorder("in_person.habit_situation_start_date_line", new EditBorder("in_person.habit_situation_start_date_border", ddc4, true)));
