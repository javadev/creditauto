...
public class ClientPersonalInfoPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public ClientPersonalInfoPage() {
        super();
    ...
    public ClientPersonalInfoPage(In_instance inInstance) {
...
form.add(new PassportInfoPanel("clientPassport", new PropertyModel(inInstance, "in_person")));
