...
public class ClientPersonalInfoViewPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public ClientPersonalInfoViewPage() {
        super();
    ...
    public ClientPersonalInfoViewPage(In_instance inInstance) {
    ...
    private void init() {
        ...
        ajaxTabbedPanel.setSelectedTab(12 - 1);
        add(ajaxTabbedPanel);
    ...
    public static String getTitle() {
        return "Персональные данные клиента";
    }
    ...
    protected class MainForm extends Form {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                DictionaryTextField ddc1 = new DictionaryTextField("in_person.dictionary_gender_id",
                    dictionary.getDictionary("gender", IDictionary.LANGUAGE_RU, new Date()),
                        new ChoiceRenderer("dvalue"));
                ddc1.setModel(new DictionaryModelWrapper(model.bind("in_person.dictionary_gender"), ddc1));
                form.add(new LineBorder("in_person.dictionary_gender_line", new EditBorder("in_person.dictionary_gender_border", ddc1, true)));
                ddc1.setOutputMarkupId(true);
                ddc1.setEnabled(false);

                TextField ddc2 = new TextField("in_person.last_name_id", model.bind("in_person.last_name"));
                form.add(new LineBorder("in_person.last_name_line", new EditBorder("in_person.last_name_border", ddc2, true)));
                ddc2.setOutputMarkupId(true);
                ddc2.setEnabled(false);

                TextField ddc3 = new TextField("in_person.first_name_id", model.bind("in_person.first_name"));
                form.add(new LineBorder("in_person.first_name_line", new EditBorder("in_person.first_name_border", ddc3, true)));
                ddc3.setOutputMarkupId(true);
                ddc3.setEnabled(false);

                TextField ddc4 = new TextField("in_person.patronymic_name_id", model.bind("in_person.patronymic_name"));
                form.add(new LineBorder("in_person.patronymic_name_line", new EditBorder("in_person.patronymic_name_border", ddc4, true)));
                ddc4.setOutputMarkupId(true);
                ddc4.setEnabled(false);

                TextField ddc5 = new TextField("in_person.birthday_id", model.bind("in_person.birthday"));
                form.add(new LineBorder("in_person.birthday_line", new EditBorder("in_person.birthday_border", ddc5, true)));
                ddc5.setOutputMarkupId(true);
                ddc5.setEnabled(false);

                TextField ddc6 = new TextField("in_person.birth_place_id", model.bind("in_person.birth_place"));
                form.add(new LineBorder("in_person.birth_place_line", new EditBorder("in_person.birth_place_border", ddc6, true)));
                ddc6.setOutputMarkupId(true);
                ddc6.setEnabled(false);

                TextField ddc7 = new TextField("in_person.tin_id", model.bind("in_person.tin"));
                form.add(new LineBorder("in_person.tin_line", new EditBorder("in_person.tin_border", ddc7, true)));
                ddc7.setOutputMarkupId(true);
                ddc7.setEnabled(false);

                TextField ddc8 = new TextField("in_person.date_of_issue_tin_certificate_id", model.bind("in_person.date_of_issue_tin_certificate"));
                form.add(new LineBorder("in_person.date_of_issue_tin_certificate_line", new EditBorder("in_person.date_of_issue_tin_certificate_border", ddc8, true)));
                ddc8.setOutputMarkupId(true);
                ddc8.setEnabled(false);

                TextField ddc9 = new TextField("in_person.date_of_giving_tin_certificate_id", model.bind("in_person.date_of_giving_tin_certificate"));
                form.add(new LineBorder("in_person.date_of_giving_tin_certificate_line", new EditBorder("in_person.date_of_giving_tin_certificate_border", ddc9, true)));
                ddc9.setOutputMarkupId(true);
                ddc9.setEnabled(false);

                TextField ddc10 = new TextField("in_person.issuer_of_tin_id", model.bind("in_person.issuer_of_tin"));
                form.add(new LineBorder("in_person.issuer_of_tin_line", new EditBorder("in_person.issuer_of_tin_border", ddc10, true)));
                ddc10.setOutputMarkupId(true);
                ddc10.setEnabled(false);

                TextField ddc11 = new TextField("in_person.identity_document_number_id", model.bind("in_person.identity_document_number"));
                form.add(new LineBorder("in_person.identity_document_number_line", new EditBorder("in_person.identity_document_number_border", ddc11, true)));
                ddc11.setOutputMarkupId(true);
                ddc11.setEnabled(false);

                TextField ddc12 = new TextField("in_person.date_of_issuing_identity_doc_id", model.bind("in_person.date_of_issuing_identity_doc"));
                form.add(new LineBorder("in_person.date_of_issuing_identity_doc_line", new EditBorder("in_person.date_of_issuing_identity_doc_border", ddc12, true)));
                ddc12.setOutputMarkupId(true);
                ddc12.setEnabled(false);

                TextField ddc13 = new TextField("in_person.issuer_of_identity_document_id", model.bind("in_person.issuer_of_identity_document"));
                form.add(new LineBorder("in_person.issuer_of_identity_document_line", new EditBorder("in_person.issuer_of_identity_document_border", ddc13, true)));
                ...
                form.addOrReplace(new Link("back") {
                    @Override 
                    public void onClick()  {
            setResponsePage(new CredittypeSelectionViewPage(inInstance));
                    }           
                                    });
