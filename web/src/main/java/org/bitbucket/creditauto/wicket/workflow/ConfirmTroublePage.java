...
public class ConfirmTroublePage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public ConfirmTroublePage() {
        super();
    ...
    public ConfirmTroublePage(In_instance inInstance) {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                form.addOrReplace(new Link("back") {
                    @Override 
                    public void onClick()  {
            setResponsePage(new ComplainPage());
                    }           
                                    });
    }
