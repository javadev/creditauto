...
public class CredittypeSelectionPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public CredittypeSelectionPage() {
        super();
    ...
    public CredittypeSelectionPage(In_instance inInstance) {
            ...
            form.setOutputMarkupId(true);
                ...
                DropDownChoice ddc3 = new DropDownChoice("in_dossier.credittype_id", model.bind("in_dossier.credittype"),
                    getCredittypes(form).credittypes,
                        new ChoiceRenderer("namescreen", "id"));
