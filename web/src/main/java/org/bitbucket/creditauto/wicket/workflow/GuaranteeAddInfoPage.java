...
public class GuaranteeAddInfoPage extends GuaranteeEmployerInfoPage {
    
    
    public GuaranteeAddInfoPage() {
        super();
    ...
    public GuaranteeAddInfoPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends GuaranteeEmployerInfoPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends GuaranteeEmployerInfoPage.MainPanel.MainForm {
...
form.add(new ClientAddInfoPanel("guarantorAddInfo", new PropertyModel(inInstance, "in_guarantor")));

form.add(new NotesPanel("guarantorNotesPanel", new PropertyModel(inInstance, "in_dossier")));
