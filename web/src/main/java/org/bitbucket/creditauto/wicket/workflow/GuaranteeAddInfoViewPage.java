...
public class GuaranteeAddInfoViewPage extends GuaranteeEmployerInfoViewPage {
    
    
    public GuaranteeAddInfoViewPage() {
        super();
    ...
    public GuaranteeAddInfoViewPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends GuaranteeEmployerInfoViewPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends GuaranteeEmployerInfoViewPage.MainPanel.MainForm {
...
form.add(new ClientAddInfoViewPanel("guarantorAddInfo", new PropertyModel(inInstance, "in_guarantor")));

form.add(new NotesViewPanel("guarantorNotesPanel", new PropertyModel(inInstance, "in_dossier")));
