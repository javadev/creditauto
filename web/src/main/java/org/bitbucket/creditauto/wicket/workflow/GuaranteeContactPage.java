...
public class GuaranteeContactPage extends GuaranteePersonalInfoPage {
    
    
    public GuaranteeContactPage() {
        super();
    ...
    public GuaranteeContactPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends GuaranteePersonalInfoPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends GuaranteePersonalInfoPage.MainPanel.MainForm {
...
form.add(new AddressRegPanel("guarantorAddressReg", new PropertyModel(inInstance, "in_guarantor")));

form.add(new AddressMailPanel("guarantorAddressMail", new PropertyModel(inInstance, "in_guarantor")));
