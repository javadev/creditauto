...
public class GuaranteeContactViewPage extends GuaranteePersonalInfoViewPage {
    
    
    public GuaranteeContactViewPage() {
        super();
    ...
    public GuaranteeContactViewPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends GuaranteePersonalInfoViewPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends GuaranteePersonalInfoViewPage.MainPanel.MainForm {
...
form.add(new AddressRegViewPanel("guarantorAddressReg", new PropertyModel(inInstance, "in_guarantor")));

form.add(new AddressMailViewPanel("guarantorAddressMail", new PropertyModel(inInstance, "in_guarantor")));
