...
public class GuaranteeEmployerInfoPage extends GuaranteeContactPage {
    
    
    public GuaranteeEmployerInfoPage() {
        super();
    ...
    public GuaranteeEmployerInfoPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends GuaranteeContactPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends GuaranteeContactPage.MainPanel.MainForm {
...
form.add(new EmployerAddressPanel("guarantorEmployer", new PropertyModel(inInstance, "in_guarantor")));
