...
public class GuaranteePartnerInfoViewPage extends GuaranteeAddInfoViewPage {
    
    
    public GuaranteePartnerInfoViewPage() {
        super();
    ...
    public GuaranteePartnerInfoViewPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends GuaranteeAddInfoViewPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends GuaranteeAddInfoViewPage.MainPanel.MainForm {
...
form.add(new PartnerPassportViewPanel("guarantorPartnerInfo", new PropertyModel(inInstance, "in_guarantor_partner")));

                form.addOrReplace(new Link("back") {
                    @Override 
                    public void onClick()  {
            setResponsePage(new ThirdPersonInfoViewPage());
                    }           
                                    });
                form.addOrReplace(new SubmitLink("next") {
                    @Override 
                    public void  onSubmit() {
            setResponsePage(new PrintApplicationFormViewPage());
                    }           
                                    });
    }
