...
public class GuaranteePersonalInfoPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public GuaranteePersonalInfoPage() {
        super();
    ...
    public GuaranteePersonalInfoPage(In_instance inInstance) {
...
form.add(new PassportInfoPanel("guarantorPassport", new PropertyModel(inInstance, "in_guarantor")));
...
form.add(new MaritalStatusPanel("guarantorMarital", new PropertyModel(inInstance, "in_guarantor")));
