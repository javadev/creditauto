...
public class GuaranteePersonalInfoViewPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public GuaranteePersonalInfoViewPage() {
        super();
    ...
    public GuaranteePersonalInfoViewPage(In_instance inInstance) {
...
form.add(new PassportInfoViewPanel("guarantorPassport", new PropertyModel(inInstance, "in_guarantor")));

form.add(new MaritalStatusViewPanel("guarantorMarital", new PropertyModel(inInstance, "in_guarantor")));
