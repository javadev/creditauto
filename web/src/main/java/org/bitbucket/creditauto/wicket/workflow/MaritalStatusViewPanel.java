...
public class MaritalStatusViewPanel extends Panel {
    protected IDictionary dictionary;
    private final   In_person modelObject;
    
    
        public MaritalStatusViewPanel(String id, IModel model) {
            super(id, model);
    ...
    CompoundPropertyModel model = new CompoundPropertyModel(modelObject); 
            ...
            form.setOutputMarkupId(true);
                ...
                DictionaryTextField ddc1 = new DictionaryTextField("dictionary_marital_status_id",
                ...
                DictionaryTextField ddc3 = new DictionaryTextField("dictionary_habitation_situation_id",
