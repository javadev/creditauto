...
public class NotesPanel extends Panel {
    ...
    private final   In_dossier modelObject;
        ...
        public NotesPanel(String id, IModel model) {
            super(id, model);
    ...
    CompoundPropertyModel model = new CompoundPropertyModel(modelObject); 
            ...
            form.setOutputMarkupId(true);
                ...
                TextArea ddc1 = new TextArea("text_id", new PropertyModel(this, "text"));
                form.add(new LineBorder("text_line", new EditBorder("text_border", ddc1, true)));
                ddc1.setOutputMarkupId(true);
                form.get("text_line").setOutputMarkupPlaceholderTag(true);

    AjaxSubmitLink ddc2 = new AjaxSubmitLink("addNote_id") {
            @Override
             ...
             form.add(new LineBorder("addNote_line", ddc2));
    ...
    ListView listview = new ListView("listNotes", modelObject.getIn_bloknots()) {
        ...
        protected void populateItem(ListItem item) {
            ...
            item.setModel(model);
                ...
                target.addComponent(form.get("listNotes_container"));
                     }           
                });
                                                   }
        @Override
