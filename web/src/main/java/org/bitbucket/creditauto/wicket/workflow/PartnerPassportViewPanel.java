...
public class PartnerPassportViewPanel extends Panel {
    protected IDictionary dictionary;
    private final   In_person modelObject;
    
    
        public PartnerPassportViewPanel(String id, IModel model) {
            super(id, model);
    ...
    CompoundPropertyModel model = new CompoundPropertyModel(modelObject); 
            ...
            form.setOutputMarkupId(true);
                ...
                TextField ddc1 = new TextField("last_name_id", model.bind("last_name"));
                form.add(new LineBorder("last_name_line", new EditBorder("last_name_border", ddc1, true)));
                ddc1.setOutputMarkupId(true);
                ddc1.setEnabled(false);

                TextField ddc2 = new TextField("first_name_id", model.bind("first_name"));
                form.add(new LineBorder("first_name_line", new EditBorder("first_name_border", ddc2, true)));
                ddc2.setOutputMarkupId(true);
                ddc2.setEnabled(false);

                TextField ddc3 = new TextField("patronymic_name_id", model.bind("patronymic_name"));
                form.add(new LineBorder("patronymic_name_line", new EditBorder("patronymic_name_border", ddc3, true)));
                ...
                CheckBox ddc5 = new CheckBox("has_no_tin_id", model.bind("has_no_tin"));
                ...
                DictionaryTextField ddc10 = new DictionaryTextField("citizenship_id",
                ...
                DictionaryTextField ddc11 = new DictionaryTextField("dict_identity_document_type_id",
