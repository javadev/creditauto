...
public class PartnerPersonalInfoPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public PartnerPersonalInfoPage() {
        super();
    ...
    public PartnerPersonalInfoPage(In_instance inInstance) {
...
form.add(new PassportInfoPanel("partnerPassport", new PropertyModel(inInstance, "in_person_partner")));
