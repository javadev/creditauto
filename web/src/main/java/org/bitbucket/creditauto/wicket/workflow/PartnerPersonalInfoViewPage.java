...
public class PartnerPersonalInfoViewPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public PartnerPersonalInfoViewPage() {
        super();
    ...
    public PartnerPersonalInfoViewPage(In_instance inInstance) {
    ...
    public static String getTitle() {
        return "Персональные данные партнера";
    }
...
form.add(new PartnerPassportViewPanel("partnerPassport", new PropertyModel(inInstance, "in_person_partner")));
            ...
            setResponsePage(new ClientAddressMailChooseViewPage());
                    }           
                                    });
    }
