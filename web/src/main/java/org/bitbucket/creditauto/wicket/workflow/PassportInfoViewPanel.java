...
public class PassportInfoViewPanel extends Panel {
    protected IDictionary dictionary;
    private final   In_person modelObject;
    
    
        public PassportInfoViewPanel(String id, IModel model) {
            super(id, model);
    ...
    CompoundPropertyModel model = new CompoundPropertyModel(modelObject); 
            ...
            form.setOutputMarkupId(true);
                ...
                DictionaryTextField ddc1 = new DictionaryTextField("dictionary_gender_id",
