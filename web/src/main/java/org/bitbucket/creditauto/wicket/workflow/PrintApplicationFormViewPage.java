...
public class PrintApplicationFormViewPage extends TemplatePage {
    protected IDictionary dictionary;
    protected In_instance inInstance;
    
    
    public PrintApplicationFormViewPage() {
        super();
    ...
    public PrintApplicationFormViewPage(In_instance inInstance) {
    ...
    Link ddc1 = new Link("print-application-form_id") {
            @Override
            public void onClick() {
        ...
        form.add(new LineBorder("print-application-form_line", ddc1));

                AjaxCheckBox ddc2 = new AjaxCheckBox("in_dossier.is_application_form_signed_id", model.bind("in_dossier.is_application_form_signed")) {
                                            @Override
                        protected void onUpdate(AjaxRequestTarget target) {
                             
                        }                    
                                                        };
                form.add(new LineBorder("in_dossier.is_application_form_signed_line", new EditBorder("in_dossier.is_application_form_signed_border", ddc2, true)));
                ddc2.setOutputMarkupId(true);
                inInstance.getIn_dossier().setIs_application_form_signed(false);
            ...
            setResponsePage(new ClientDocumentStoreViewPage(inInstance));
                    }           
                                    });
    }
