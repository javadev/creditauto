...
public class ThirdPersonInfoPage extends ClientContactInfoPage {
    
    
    public ThirdPersonInfoPage() {
        super();
    ...
    public ThirdPersonInfoPage(In_instance inInstance) {
        super(inInstance);
    ...
    private void init() {
        ...
        ajaxTabbedPanel.setSelectedTab(10 - 1);
    ...
    protected class MainPanel extends ClientContactInfoPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends ClientContactInfoPage.MainPanel.MainForm {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                DropDownChoice ddc5 = new DropDownChoice("in_third_person.dict_type_of_relation_client_id",
                ...
                form.addOrReplace(new Link("back") {
                    @Override 
                    public void onClick()  {
            setResponsePage(new ClientContactInfoPage());
                    }           
                                    });
