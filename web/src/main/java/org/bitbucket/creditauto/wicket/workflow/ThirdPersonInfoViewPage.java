...
public class ThirdPersonInfoViewPage extends ClientContactInfoViewPage {
    
    
    public ThirdPersonInfoViewPage() {
        super();
    ...
    public ThirdPersonInfoViewPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends ClientContactInfoViewPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends ClientContactInfoViewPage.MainPanel.MainForm {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                TextField ddc1 = new TextField("in_third_person.last_name_id", model.bind("in_third_person.last_name"));
                form.add(new LineBorder("in_third_person.last_name_line", new EditBorder("in_third_person.last_name_border", ddc1, true)));
                ddc1.setOutputMarkupId(true);
                ddc1.setEnabled(false);

                TextField ddc2 = new TextField("in_third_person.first_name_id", model.bind("in_third_person.first_name"));
                form.add(new LineBorder("in_third_person.first_name_line", new EditBorder("in_third_person.first_name_border", ddc2, true)));
                ddc2.setOutputMarkupId(true);
                ddc2.setEnabled(false);

                TextField ddc3 = new TextField("in_third_person.patronymic_name_id", model.bind("in_third_person.patronymic_name"));
                form.add(new LineBorder("in_third_person.patronymic_name_line", new EditBorder("in_third_person.patronymic_name_border", ddc3, true)));
                ddc3.setOutputMarkupId(true);
                ddc3.setEnabled(false);

                TextField ddc4 = new TextField("in_third_person.phone_id", model.bind("in_third_person.phone"));
                form.add(new LineBorder("in_third_person.phone_line", new EditBorder("in_third_person.phone_border", ddc4, true)));
                ddc4.setOutputMarkupId(true);
                ddc4.setEnabled(false);

                DictionaryTextField ddc5 = new DictionaryTextField("in_third_person.dict_type_of_relation_client_id",
                    dictionary.getDictionary("relationThirdPartyList", IDictionary.LANGUAGE_RU, new Date()),
                        new ChoiceRenderer("dvalue"));
                ddc5.setModel(new DictionaryModelWrapper(model.bind("in_third_person.dict_type_of_relation_client"), ddc5));
                form.add(new LineBorder("in_third_person.dict_type_of_relation_client_line", new EditBorder("in_third_person.dict_type_of_relation_client_border", ddc5, true)));
                ...
                form.addOrReplace(new Link("back") {
                    @Override 
                    public void onClick()  {
            setResponsePage(new ClientContactInfoViewPage(inInstance));
                    }           
                                    });
                form.addOrReplace(new SubmitLink("next") {
                    @Override 
                    public void  onSubmit() {
            setResponsePage(new PrintApplicationFormViewPage(inInstance));
                    }           
                                    });
    }
