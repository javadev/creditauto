...
public class UserPowerOfAttorneyViewPage extends UserManagementViewPage {
    
    
        private SimpleDateFormat format;
        private ITarification tarification;
    public UserPowerOfAttorneyViewPage() {
        super();
                this.inInstance = getCreditautoSession().getInInstance();
        init();       
    }
    
    public UserPowerOfAttorneyViewPage(User user) {
        super( user );
        this.inInstance = getCreditautoSession().getInInstance();
        this.user = user;
    ...
    public UserPowerOfAttorneyViewPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends UserManagementViewPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends UserManagementViewPage.MainPanel.MainForm {
