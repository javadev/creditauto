...
public class UserRolesPage extends TemplatePage {
    ...
    public UserRolesPage(User user) {
        super();
        this.inInstance = getCreditautoSession().getInInstance();
        this.user = user;
    ...
    public UserRolesPage(In_instance inInstance) {
            ...
            item.setModel(model);
                                                          item.add(new Label("id", model.bind("id")));
                                                                                     ...
                                                                                     item.add(new Label("competence_level.name", model.bind("competence_level.name")));
                                                                                       item.add(new AjaxCheckBox("droplink", new Model(getRolesMap().get(modelObject.getId()))) {
                     @Override 
