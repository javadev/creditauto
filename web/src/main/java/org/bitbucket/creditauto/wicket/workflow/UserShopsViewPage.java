...
public class UserShopsViewPage extends UserPowerOfAttorneyViewPage {
    
    
    public UserShopsViewPage() {
        super();
                this.inInstance = getCreditautoSession().getInInstance();
        init();       
    }
    
    public UserShopsViewPage(User user) {
        super( user );
        this.inInstance = getCreditautoSession().getInInstance();
        this.user = user;
    ...
    public UserShopsViewPage(In_instance inInstance) {
        super(inInstance);
    ...
    protected class MainPanel extends UserPowerOfAttorneyViewPage.MainPanel {
        public MainPanel(String id) {
            super(id);
        }
    protected class MainForm extends UserPowerOfAttorneyViewPage.MainPanel.MainForm {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                form.addOrReplace(new Link("back") {
                    @Override 
                    public void onClick()  {
            setResponsePage(new UserRolesViewPage(user));
                    }           
                                    });
