...
public class UserViewPage extends TemplatePage {
    ...
    public UserViewPage(In_instance inInstance) {
    ...
    protected class MainForm extends Form {
        ...
        public MainForm(String id) {
            ...
            form.setOutputMarkupId(true);
                ...
                TextField ddc1 = new TextField("login_id", model.bind("login"));
                form.add(new LineBorder("login_line", new EditBorder("login_border", ddc1, true)));
                ddc1.setOutputMarkupId(true);
                ddc1.setEnabled(false);

                TextField ddc2 = new TextField("name_id", model.bind("name"));
                form.add(new LineBorder("name_line", new EditBorder("name_border", ddc2, true)));
                ddc2.setOutputMarkupId(true);
                ddc2.setEnabled(false);

                TextField ddc3 = new TextField("description_id", model.bind("description"));
                form.add(new LineBorder("description_line", new EditBorder("description_border", ddc3, true)));
                ddc3.setOutputMarkupId(true);
                ddc3.setEnabled(false);

                CheckBox ddc4 = new CheckBox("is_nst_id", model.bind("is_nst"));
                form.add(new LineBorder("is_nst_line", new EditBorder("is_nst_border", ddc4, true)));
                ddc4.setOutputMarkupId(true);
                ddc4.setEnabled(false);

                TextField ddc5 = new TextField("table_number_id", model.bind("table_number"));
                form.add(new LineBorder("table_number_line", new EditBorder("table_number_border", ddc5, true)));
                ddc5.setOutputMarkupId(true);
                ddc5.setEnabled(false);

                TextField ddc6 = new TextField("phone_id", model.bind("phone"));
                form.add(new LineBorder("phone_line", new EditBorder("phone_border", ddc6, true)));
                ddc6.setOutputMarkupId(true);
                ddc6.setEnabled(false);

                TextField ddc7 = new TextField("phone2_id", model.bind("phone2"));
                form.add(new LineBorder("phone2_line", new EditBorder("phone2_border", ddc7, true)));
