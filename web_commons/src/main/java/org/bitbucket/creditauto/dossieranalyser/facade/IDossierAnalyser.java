...
public interface IDossierAnalyser {
    /**
     * On some stages when we go through user work flow to create deal we should put our deal on
     * special complicated processing to be handled by dossier analyser server in asynchronous mode.
     * This method is designed to do it.
     *
     ...
     * @param tobeStatus - Status name to be assigned for deal during processing and before dossier
     *     analyser assigns final status according appropriate processing defined by profile
     *     name/number
     * @param user - user name/login just for log reasons
     * @return unified result object
     */
    GeneralResult analyseDossier(
