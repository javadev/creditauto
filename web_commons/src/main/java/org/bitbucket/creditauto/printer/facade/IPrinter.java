...
public interface IPrinter {
     ...
     */
    byte[] printDocumentFromInstance(In_instance instance, PrinterDocumentType documentType)
     ...
     * @return the PDF binary image
     */
    byte[] printDocumentFromDB(long dossierId, PrinterDocumentType documentType)
            throws PrinterException;
