...
public class MoneyToStr {
    ...
    /**
     * Inits class with currency. Usage: MoneyToStr moneyToStr = new MoneyToStr("UAH"); Definition
     * for currency is placed into currlist.xml
     *
    ...
    public static String percentToStr(Double amount, Language lang) {
        ...
        if (amount.floatValue() == amount.intValue()) {
            result =
                    new MoneyToStr(Currency.PER10, lang, Pennies.TEXT)
                            .convert(amount.longValue(), 0L);
            ...
            result =
                    new MoneyToStr(Currency.PER100, lang, Pennies.TEXT).convert(intPart, fractPart);
            ...
            result =
                    new MoneyToStr(Currency.PER1000, lang, Pennies.TEXT)
                            .convert(intPart, fractPart);
        } else {
            fractPart = Math.round((amount - intPart) * NUM10000);
            result =
                    new MoneyToStr(Currency.PER10000, lang, Pennies.TEXT)
                            .convert(intPart, fractPart);
        }
        return result;
    }
    ...
    /**
     * Converts number to currency. Usage: MoneyToStr moneyToStr = new MoneyToStr("UAH"); String
     * result = moneyToStr.convert(123D); Expected: result = сто двадцять три гривні 00 копійок
     *
