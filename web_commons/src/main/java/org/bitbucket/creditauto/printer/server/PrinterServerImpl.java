...
public class PrinterServerImpl implements IPrinter {
    ...
    private void createPDFJasper(List<String> templateNames, ByteArrayOutputStream os) throws PrinterException {
    ...
    private String applyVelocityTemplate(String templateData, String basePath) throws Exception {
        ...
        repo.putStringResource("template", templateData.replace("application-form-ukr.files", "${basePath}/application-form-ukr.files"));
