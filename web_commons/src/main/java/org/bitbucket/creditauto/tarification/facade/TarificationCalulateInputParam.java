...
public class TarificationCalulateInputParam implements Serializable {
    ...
    public TarificationCalulateInputParam(
            double amount, double goodPrice, long duration, long externalDistributorId) {
    ...
    public String toString() {
        return "TarificationCalulateInputParam [amount="
                + amount
                + ", creditTypeId="
                + (creditType == null ? "" : String.valueOf(creditType.getId()))
                + "]";
    }
}
