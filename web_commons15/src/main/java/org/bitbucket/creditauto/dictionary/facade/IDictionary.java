...
public interface IDictionary {
     ...
     * @return the list of objects
     */
    String getDictionaryItem(String dictionaryName, String dictionaryKey, Date date, String ... languages);
     ...
     * @return the list of objects
     */
    String getDictionaryItem(String dictionaryName, String dictionaryExp, String dictionaryKey, Date date, String ... languages);
     ...
     * @return the list of objects
     */
    String getDictionaryItem(String dictionaryName, String dictionaryExp, String dictionaryExp2, String dictionaryKey, Date date, String ... languages);
     ...
     * @return the list of objects
     */
    List<Dictionary_data> getDictionary(String dictionaryName, String expKey, String language, Date date);
     ...
     * @return the list of objects
     */
    List<Dictionary_data> getDictionary(String dictionaryName, String expKey, String expKey2, String language, Date date);
