...
public class DictionaryExpDirective extends Directive {
    ...
    private String dictionaryExp(String dictionaryName, String dictionaryExp, String dictionaryKey) {
        if (dictionaryName == null || dictionaryKey == null) {
            return null;
        }
        return dictionary.getDictionaryItem(dictionaryName, dictionaryExp, dictionaryKey, new java.util.Date(), IDictionary.LANGUAGE_UK, IDictionary.LANGUAGE_RU);
    }
}
